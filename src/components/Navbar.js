      ...
      <div className="top_header">
        <div className="content_box">
          <div className="content">
            ...
            <div className="text">+92 3455555396</div>
          </div>
          <div className="content mob-content">
            <div className="icon">
              <FaLocationDot />
            </div>
            <div className="text">
          ...
          <div className="content">
            ...
            <div className="text">Mon - Fri 8.00 - 20.00</div>
          </div>
          <div className="align-it">
            <div className="content mob-content" id="first">
              <div className="icon">
                <FaFacebook />
              </div>
              <div className="icon">
            ...
            <div className="content" id="second">
              ...
              <div className="text">
                <div className="user">
                  <a href="https://ezitech.org/user-account/">
                    <span className="user_text">Login</span>
                  </a>
                  <span className="user_text">|</span>
                  <a href="https://ezitech.org/user-account/">
                    <span className="user_text">Register</span>
                  </a>
                </div>
              </div>
            </div>
      ...
      <div className="last_header">
        <div className="logo">
          <a href="http://ezitech.org/">
            <img
              src="http://ezitech.org/wp-content/uploads/2023/02/EZITECH-LOGO-white.png"
              alt="logos"
              style={{ width: 0 }}
            />
            <img
              className="img-responsive logo_colored_fixed hidden"
              src="http://ezitech.org/wp-content/uploads/2023/02/EZITECH-LOGO-1.png"
              alt="Ezitech"
              style={{ width: 170 }}
            />
          </a>
        </div>
        <div className={`nav_links ${Mobile ? "show" : ""}`}>
          <a
          ...
          <a
            ...
            href="https://ezitech.org/about-ezitech/"
          ...
          <a
            ...
            href="https://ezitech.org/certifications/"
          ...
          >
            ...
            {isDropdown && (
              <div className="drop_down_1">
                <a href="https://ezitech.org/course/free-courses/">
                  Free Courses
                </a>
                <a href="https://ezitech.org/course/onsite-courses-for-it-freelancing/">
                  Online Courses
                </a>
              </div>
            )}
          ...
          <a
            ...
            href="https://ezitech.org/internship-program/"
          ...
          <a
            style={{ position: "relative", paddingBottom: "150px" }}
            className={activeLink === "EZI UPDATES" ? "active" : ""}
            href="https://ezitech.org/ezi-updates/"
            onClick={() => handleClick("EZI UPDATES")}
          ...
          >
            ...
            {isThirdDrop && (
              <div className="drop_down_2">
                <a href="https://ezitech.org/skill-assignments/">
                  Skill Assignment
                </a>
              </div>
            )}
